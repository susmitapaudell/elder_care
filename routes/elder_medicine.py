...
@router.get("/caregiver/{user_id}/medicine", response_class=HTMLResponse)
...
@router.post("/caregiver/{user_id}/save_medicine")
...
@router.get("/caregiver/{user_id}/load_medicine")
